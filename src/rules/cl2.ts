...
export const isCL2Result: Refinement<AnySequent, AnyCL2Result> = refineActiveL(isConjunction);
...
export type ApplyCL2<A extends Prop, S extends AnyDerivation> = S extends Derivation<
  Sequent<[...infer Γ extends Formulas, infer B extends Prop], infer Δ>
> ? CL2<Γ, A, B, Δ, CL2Result<Γ, A, B, Δ>> : never;
