...
export const isNRResult: Refinement<AnySequent, AnyNRResult> = refineActiveR(isNegation);
...
export type ApplyNR<S extends AnyDerivation> = S extends Derivation<
  Sequent<[...infer Γ extends Formulas, infer A extends Prop], infer Δ>
> ? NR<Γ, A, Δ, NRResult<Γ, A, Δ>> : never;
