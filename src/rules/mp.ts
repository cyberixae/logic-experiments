...
import { Prop, Implication, implication } from '../model/prop';
import { Conclusion, AnyConclusion, conclusion } from '../model/sequent';
...
> = Transformation<
  C, [Derivation<Conclusion<Implication<P, Q>>>, Derivation<Conclusion<P>>], 'MP'
>;
