...
export type Axiom1<P extends Prop, Q extends Prop> = Implication<P, Implication<Q, P>>;
export type AnyAxiom1 = Axiom1<Prop, Prop>;
export const isAxiom1: Refinement<Prop, AnyAxiom1> = (
  p
): p is AnyAxiom1 => {
  const piqip = p;
...
export const isA1Result: Refinement<AnySequent, AnyA1Result> = (s: AnySequent): s is AnyA1Result => {
