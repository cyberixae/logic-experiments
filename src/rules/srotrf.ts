...
export type ApplySRotRF<S extends AnyDerivation> = S extends Derivation<
  Sequent<
    infer Γ, [infer A extends Prop, infer B extends Prop, ...infer Δ extends Formulas]
  >
> ? SRotRF<Γ, B, Δ, A, SRotRFResult<Γ, B, Δ, A>> : never;
