...
export type ApplySRotLB<S extends AnyDerivation> = S extends Derivation<
  Sequent<
    [infer A extends Prop, ...infer Γ extends Formulas, infer B extends Prop], infer Δ
  >
> ? SRotLB<Γ, B, A, Δ, SRotLBResult<Γ, B, A, Δ>> : never;
