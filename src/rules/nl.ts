...
export const isNLResult: Refinement<AnySequent, AnyNLResult> = refineActiveL(isNegation);
...
export type ApplyNL<S extends AnyDerivation> = S extends Derivation<
  Sequent<infer Γ, [infer A extends Prop, ...infer Δ extends Formulas]>
> ? NL<Γ, A, Δ, NLResult<Γ, A, Δ>> : never;
