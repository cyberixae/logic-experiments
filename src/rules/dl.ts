...
import { Prop, Disjunction, isDisjunction, disjunction, atom } from '../model/prop';
...
export const isDLResult: Refinement<AnySequent, AnyDLResult> = refineActiveL(isDisjunction);
...
> = Transformation<
  R, [Derivation<Sequent<[...Γ, A], Δ>>, Derivation<Sequent<[...Γ, B], Δ>>], 'dl'
>;
...
export type ApplyDL<S1 extends AnyDerivation, S2 extends AnyDerivation> = [
  ...
  S2
    ...
    >
  ] ? DL<Γ, A, B, Δ, DLResult<Γ, A, B, Δ>> : never;
