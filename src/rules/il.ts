...
export const isILResult: Refinement<AnySequent, AnyILResult> = refineActiveL(isImplication);
...
> = Transformation<
  R, [Derivation<Sequent<Γ, [A, ...Δ]>>, Derivation<Sequent<[...Γ, B], Δ>>], 'il'
>;
...
export type ApplyIL<S1 extends AnyDerivation, S2 extends AnyDerivation> = [
  ...
  S2
    ...
    >
  ] ? IL<Γ, A, B, Δ, ILResult<Γ, A, B, Δ>> : never;
