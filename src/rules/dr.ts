...
export type ApplyDR<S extends AnyDerivation> = S extends Derivation<
  Sequent<infer Γ, [infer A extends Prop, infer B extends Prop, ...infer Δ extends Formulas]>
> ? DR<Γ, A, B, Δ, DRResult<Γ, A, B, Δ>> : never;
