...
export const helpSystems = {
  rk: { id: 'rk', name: rk.meta.name, meta: rk.meta, exampleProof: rk.exampleProof },
  fk: { id: 'fk', name: fk.meta.name, meta: fk.meta, exampleProof: fk.exampleProof },
  la3: { id: 'la3', name: la3.meta.name, meta: la3.meta, exampleProof: la3.exampleProof },
} as const
