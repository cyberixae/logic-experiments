...
// text and nowhere else — except Identity and Constants, whose owl lines
// state the closing conditions without naming them: the row title alone
// carries the term, and a player who never connects the two loses nothing.
